...
class Organisatie:
    ...
    def insert_onderzoek(self,titel,beschjrijving,datum_vanaf,datum_tot,typeonderzoek,vergoeding,hoeveel_vergoeding,leeftijd_vanaf,leeftijd_tot,beperking_id):
        self.cursor.execute(
            "INSERT into onderzoeken (titel,beschrijving,datum_vanaf,datum_tot,type,locatie,met_beloning,beloning,beperking,leeftijd_van,leeftijd_tot,beperking_id) VALUES (?,?,?,?,?,?,?,?,?,?)",
